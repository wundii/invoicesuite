...
final class ZfFxUnifiedMinimumProviderTest extends TestCase
{
    public function testGetUniqueId(): void
    {
        $provider = new InvoiceSuiteZfFxUnifiedMinimumProvider();
    ...
    public function testGetParameters(): void
    {
        ...
        $this->assertSame(InvoiceSuiteZfFxUnifiedProfiles::MINIMUM->value, $provider->getParameters()['WantsMaximumProfile']);
    }
