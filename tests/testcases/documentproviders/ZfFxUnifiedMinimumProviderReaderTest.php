...
final class ZfFxUnifiedMinimumProviderReaderTest extends TestCase
{
    /**
     * The reader
     *
    ...
    {
        static::$document = new InvoiceSuiteZfFxUnifiedProviderReader(new InvoiceSuiteZfFxUnifiedMinimumProvider());
