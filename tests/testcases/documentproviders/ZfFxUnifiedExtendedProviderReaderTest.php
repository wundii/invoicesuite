...
final class ZfFxUnifiedExtendedProviderReaderTest extends TestCase
{
    /**
     * The reader
     *
    ...
    {
        static::$document = new InvoiceSuiteZfFxUnifiedProviderReader(new InvoiceSuiteZfFxUnifiedExtendedProvider());
