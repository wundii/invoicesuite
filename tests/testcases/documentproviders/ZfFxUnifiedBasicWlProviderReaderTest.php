...
final class ZfFxUnifiedBasicWlProviderReaderTest extends TestCase
{
    /**
     * The reader
     *
    ...
    {
        static::$document = new InvoiceSuiteZfFxUnifiedProviderReader(new InvoiceSuiteZfFxUnifiedBasicWlProvider());
