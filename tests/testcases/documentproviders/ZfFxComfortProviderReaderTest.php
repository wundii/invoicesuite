...
final class ZfFxComfortProviderReaderTest extends TestCase
{
    /**
     * The reader
     *
    ...
    {
        static::$document = new InvoiceSuiteZfFxComfortProviderReader(new InvoiceSuiteZfFxComfortProvider());
