...
use horstoeko\invoicesuite\documents\providers\zffxunified\InvoiceSuiteZfFxUnifiedBasicProvider;
...
final class ZfFxUnifiedBasicProviderTest extends TestCase
{
    public function testGetUniqueId(): void
    {
        $provider = new InvoiceSuiteZfFxUnifiedBasicProvider();
    ...
    public function testGetParameters(): void
    {
        ...
        $this->assertSame(InvoiceSuiteZfFxUnifiedProfiles::BASIC->value, $provider->getParameters()['WantsMaximumProfile']);
    }
