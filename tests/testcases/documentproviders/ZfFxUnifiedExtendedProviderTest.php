...
final class ZfFxUnifiedExtendedProviderTest extends TestCase
{
    public function testGetUniqueId(): void
    {
        $provider = new InvoiceSuiteZfFxUnifiedExtendedProvider();
    ...
    public function testGetParameters(): void
    {
        ...
        $this->assertSame(InvoiceSuiteZfFxUnifiedProfiles::EXTENDED->value, $provider->getParameters()['WantsMaximumProfile']);
    }
