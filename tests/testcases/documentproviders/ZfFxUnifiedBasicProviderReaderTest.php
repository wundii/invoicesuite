...
final class ZfFxUnifiedBasicProviderReaderTest extends TestCase
{
    /**
     * The reader
     *
    ...
    {
        static::$document = new InvoiceSuiteZfFxUnifiedProviderReader(new InvoiceSuiteZfFxUnifiedBasicProvider());
