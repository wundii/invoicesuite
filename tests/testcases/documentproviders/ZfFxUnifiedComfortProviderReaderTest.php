...
use horstoeko\invoicesuite\documents\providers\zffxunified\InvoiceSuiteZfFxUnifiedComfortProvider;
...
final class ZfFxUnifiedComfortProviderReaderTest extends TestCase
{
    /**
     * The reader
     *
    ...
    {
        static::$document = new InvoiceSuiteZfFxUnifiedProviderReader(new InvoiceSuiteZfFxUnifiedComfortProvider());
