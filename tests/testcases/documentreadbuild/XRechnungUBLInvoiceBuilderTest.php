...
final class XRechnungUBLInvoiceBuilderTest extends TestCase
{
    ...
    public function testCreateFromDTO(): void
    {
        ...
        $this->assertXPathValueWithIndex('/ns:Invoice/cac:PaymentMeans/cbc:PaymentID', 1, 'paymentReference2');
        ...
        $this->assertXPathValueWithIndex('/ns:Invoice/cac:InvoiceLine/cbc:AccountingCost', 0, 'PREF-1');
        $this->assertXPathNotExistsWithIndex('/ns:Invoice/cac:InvoiceLine/cbc:AccountingCost', 1);
