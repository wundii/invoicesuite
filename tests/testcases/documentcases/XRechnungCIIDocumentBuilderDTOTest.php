...
final class XRechnungCIIDocumentBuilderDTOTest extends TestCase
{
    use HandlesXmlTests;
    ...
    {
        $this->assertXPathValueWithIndex('//rsm:CrossIndustryInvoice/rsm:ExchangedDocumentContext/ram:GuidelineSpecifiedDocumentContextParameter/ram:ID', 0, 'urn:cen.eu:en16931:2017#compliant#urn:xeinkauf.de:kosit:xrechnung_3.0');
    ...
    public function testMessageBag(): void
    {
        ...
        $this->assertSame('EXIT horstoeko\invoicesuite\documents\providers\zffxcomfort\InvoiceSuiteZfFxComfortProviderBuilder::setDocumentTaxCurrency', static::$document->getWarningMessagesInMessageBag()[0]->getMessageContent());
    ...
    private function getStoreFilename(): string
    {
        return InvoiceSuitePathUtils::combinePathWithFile(
            ...
            '00_case_xrechnung_cii_simple_dto.xml'
        );
    }
}
