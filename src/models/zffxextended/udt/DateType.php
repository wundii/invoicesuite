...
class DateType
{
    ...
    /**
     * @var \horstoeko\invoicesuite\models\zffxextended\udt\DateType\DateStringAType|null
     * @JMS\Groups({"zffx"})
    ...
    /**
     * @param \horstoeko\invoicesuite\models\zffxextended\udt\DateType\DateStringAType|null $dateString
     * @return self
     */
