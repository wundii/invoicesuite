...
class FormattedDateTimeType
{
    ...
    /**
     * @var \horstoeko\invoicesuite\models\zffxbasic\qdt\FormattedDateTimeType\DateTimeStringAType|null
     * @JMS\Groups({"zffx"})
    ...
    /**
     * @param \horstoeko\invoicesuite\models\zffxbasic\qdt\FormattedDateTimeType\DateTimeStringAType|null $dateTimeString
     * @return self
     */
