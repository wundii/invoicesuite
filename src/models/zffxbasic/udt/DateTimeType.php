...
class DateTimeType
{
    ...
    /**
     * @var \horstoeko\invoicesuite\models\zffxbasic\udt\DateTimeType\DateTimeStringAType
     * @JMS\Groups({"zffx"})
    ...
    /**
     * @param \horstoeko\invoicesuite\models\zffxbasic\udt\DateTimeType\DateTimeStringAType $dateTimeString
     * @return self
     */
