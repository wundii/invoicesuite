...
class InstructionForReturnsLineType
{
    ...
    /**
     * @var \horstoeko\invoicesuite\models\ubl\cac\ManufacturerParty
     * @JMS\Groups({"ubl"})
     * @JMS\Type("horstoeko\invoicesuite\models\ubl\cac\ManufacturerParty")
     * @JMS\Expose
     ...
     * @return self
     */
    public function setManufacturerParty(ManufacturerParty $manufacturerParty): self
    {
