...
class DateTimeType
{
    ...
    /**
     * @var \horstoeko\invoicesuite\models\zffxcomfort\udt\DateTimeType\DateTimeStringAType
     * @JMS\Groups({"zffx"})
    ...
    /**
     * @param \horstoeko\invoicesuite\models\zffxcomfort\udt\DateTimeType\DateTimeStringAType $dateTimeString
     * @return self
     */
