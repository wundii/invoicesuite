...
class HeaderTradeAgreementType
{
     ...
     * @JMS\Groups({"zffxextended"})
     * @JMS\Type("horstoeko\invoicesuite\models\zugferd\ram\TradeDeliveryTermsType")
     * @JMS\Expose
     ...
     * @JMS\Groups({"zffxen16931", "zffxextended"})
     * @JMS\Type("horstoeko\invoicesuite\models\zugferd\ram\ProcuringProjectType")
     * @JMS\Expose
    ...
    /**
     * @param \horstoeko\invoicesuite\models\zugferd\ram\TradeDeliveryTermsType $tradeDeliveryTermsType
     * @return self
     */
    ...
    /**
     * @param \horstoeko\invoicesuite\models\zugferd\ram\ProcuringProjectType $procuringProjectType
     * @return self
     */
