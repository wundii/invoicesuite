...
use horstoeko\invoicesuite\documents\models\peppol\cac\AdditionalDocumentReference;
use horstoeko\invoicesuite\documents\models\peppol\cac\AdditionalItemProperty;
use horstoeko\invoicesuite\documents\models\peppol\cac\AllowanceCharge;
use horstoeko\invoicesuite\documents\models\peppol\cac\BillingReference;
use horstoeko\invoicesuite\documents\models\peppol\cac\ClassifiedTaxCategory;
use horstoeko\invoicesuite\documents\models\peppol\cac\CommodityClassification;
use horstoeko\invoicesuite\documents\models\peppol\cac\Contact;
use horstoeko\invoicesuite\documents\models\peppol\cac\ContractDocumentReference;
use horstoeko\invoicesuite\documents\models\peppol\cac\CreditNoteLine;
use horstoeko\invoicesuite\documents\models\peppol\cac\DespatchDocumentReference;
use horstoeko\invoicesuite\documents\models\peppol\cac\DocumentReference;
use horstoeko\invoicesuite\documents\models\peppol\cac\InvoicePeriod;
use horstoeko\invoicesuite\documents\models\peppol\cac\Item;
use horstoeko\invoicesuite\documents\models\peppol\cac\OrderLineReference;
use horstoeko\invoicesuite\documents\models\peppol\cac\OrderReference;
use horstoeko\invoicesuite\documents\models\peppol\cac\PartyIdentification;
use horstoeko\invoicesuite\documents\models\peppol\cac\PartyIdentificationType;
use horstoeko\invoicesuite\documents\models\peppol\cac\PartyLegalEntity;
use horstoeko\invoicesuite\documents\models\peppol\cac\PartyTaxScheme;
use horstoeko\invoicesuite\documents\models\peppol\cac\PaymentMeans;
use horstoeko\invoicesuite\documents\models\peppol\cac\PaymentTerms;
use horstoeko\invoicesuite\documents\models\peppol\cac\PostalAddress;
use horstoeko\invoicesuite\documents\models\peppol\cac\ReceiptDocumentReference;
use horstoeko\invoicesuite\documents\models\peppol\cac\TaxSubtotal;
use horstoeko\invoicesuite\documents\models\peppol\cbc\AccountingCost;
use horstoeko\invoicesuite\documents\models\peppol\cbc\AccountingCostCode;
use horstoeko\invoicesuite\documents\models\peppol\cbc\EndpointID;
use horstoeko\invoicesuite\documents\models\peppol\cbc\ID;
use horstoeko\invoicesuite\documents\models\peppol\cbc\Note;
use horstoeko\invoicesuite\documents\models\peppol\cbc\SalesOrderID;
...
class InvoiceSuitePeppol30CreditNoteProviderReader extends InvoiceSuiteAbstractDocumentFormatReader
{
    ...
    public function firstDocumentPosition(): bool
    {
        ...
        return InvoiceSuitePointerUtils::hasFirst(
            InvoiceSuiteArrayUtils::ensure(
                $this->getUblRootObject()->getCreditNoteLine() ?? []
            ),
            'documentposition'
        );
    }
    ...
    protected function resolveCurrentDocumentPosition(): CreditNoteLine
    {
         ...
         */
        $documentPositions = InvoiceSuiteArrayUtils::ensure($this->getUblRootObject()->getCreditNoteLine() ?? []);
