...
class InvoiceSuiteZfFxUnifiedProviderReader extends InvoiceSuiteAbstractDocumentFormatReader
{
    /**
    ...
    public function getDocumentNote(
        ...
        $newContentCode = $this->supportsAtLeastExtended() ? ($documentNote->getContentCode()?->getValue() ?? '') : '';
    ...
    public function getDocumentBillingPeriod(
        ...
        $newDescription = $this->supportsAtLeastExtended() ? ($billingPeriod->getDescription()?->getValue() ?? '') : '';
    ...
    {
        if ($this->supportsNotAtLeastBasicWl()) { // EXTENDED 0..n OTHER 0..1
            return false;
        }
    ...
    public function getDocumentPostingReference(
        ...
        $newType = $this->supportsAtLeastExtended() ? ($documentPostingReference->getTypeCode()?->getValue() ?? '') : '';
    ...
    {
        if ($this->supportsNotAtLeastEn16931()) {
            return false;
        }
    ...
    public function getDocumentSellerOrderReference(
        ...
        $newReferenceDate = $this->supportsAtLeastExtended() ? InvoiceSuiteDateTimeUtils::convertZfFxDateStringToDateTime(
    ...
    {
        if ($this->supportsNotAtLeastMinimum()) {
            return false;
        }
    ...
    public function getDocumentInvoiceReference(
        ...
        $newTypeCode = $this->supportsAtLeastExtended() ? ($documentInvoiceReference->getTypeCode()?->getValue() ?? '') : '';
    ...
    public function getDocumentSellerAddress(
        ...
        $newAddressLine1 = $this->supportsAtLeastBasicWl() ? ($documentSellerAddress->getLineOne()?->getValue() ?? '') : '';
        $newAddressLine2 = $this->supportsAtLeastBasicWl() ? ($documentSellerAddress->getLineTwo()?->getValue() ?? '') : '';
        $newAddressLine3 = $this->supportsAtLeastBasicWl() ? ($documentSellerAddress->getLineThree()?->getValue() ?? '') : '';
        $newPostcode = $this->supportsAtLeastBasicWl() ? ($documentSellerAddress->getPostcodeCode()?->getValue() ?? '') : '';
        $newCity = $this->supportsAtLeastBasicWl() ? ($documentSellerAddress->getCityName()?->getValue() ?? '') : '';
        $newCountryId = $documentSellerAddress->getCountryID()?->getValue() ?? '';
        $newSubDivision = $this->supportsAtLeastBasicWl() ? ($documentSellerAddress->getCountrySubDivisionName()?->getValue() ?? '') : '';
    ...
    public function getDocumentSellerLegalOrganisation(
        ...
        $newName = $this->supportsAtLeastBasicWl() ? ($documentSellerLegalOrganisation->getTradingBusinessName()?->getValue() ?? '') : '';
    ...
    public function getDocumentSellerContact(
        ...
        $newFaxNumber = $this->supportsAtLeastExtended() ? ($documentSellerContact->getFaxUniversalCommunication()?->getCompleteNumber()?->getValue() ?? '') : '';
    ...
    public function getDocumentBuyerLegalOrganisation(
        ...
        $newName = $this->supportsAtLeastEn16931() ? ($documentBuyerLegalOrganisation->getTradingBusinessName()?->getValue() ?? '') : '';
    ...
    public function getDocumentBuyerContact(
        ...
        $newFaxNumber = $this->supportsAtLeastExtended() ? ($documentBuyerContact->getFaxUniversalCommunication()?->getCompleteNumber()?->getValue() ?? '') : '';
    ...
    public function getDocumentPayeeLegalOrganisation(
        ...
        $newName = $this->supportsAtLeastExtended() ? ($documentPayeeLegalOrganisation->getTradingBusinessName()?->getValue() ?? '') : '';
    ...
    public function getDocumentPaymentMean(
        ...
        $newName = $this->supportsAtLeastEn16931() ? ($documentPaymentMean->getInformation()?->getValue() ?? '') : '';
        ...
        $newPayeeBic = $this->supportsAtLeastEn16931() ? ($documentPaymentMean->getPayeeSpecifiedCreditorFinancialInstitution()?->getBICID()?->getValue() ?? '') : '';
    ...
    public function getDocumentTax(
        ...
        $newTaxDueDate = $this->supportsAtLeastEn16931() ? InvoiceSuiteDateTimeUtils::convertZfFxDateStringToDateTime(
    ...
    public function getDocumentSummation(
        ...
        $newDiscountTotalAmount = $this->supportsAtLeastBasicWl() ? ($documentSummation?->getAllowanceTotalAmount()?->getValue() ?? 0.0) : 0.0;
        ...
        $newTaxTotalAmount2 = $this->supportsAtLeastBasicWl() ? (false !== $taxTotalAmount2 ? ($taxTotalAmount2->getValue() ?? 0.0) : 0.0) : 0.0;
    ...
    public function firstDocumentPosition(): bool
    {
        ...
        if ($this->supportsNotAtLeastBasic()) {
            return false;
        }
    ...
    public function getDocumentPosition(
        ...
        $newParentPositionId = $this->supportsAtLeastExtended() ? ($documentPosition->getAssociatedDocumentLineDocument()?->getParentLineID()?->getValue() ?? '') : '';
        $newLineStatusCode = $this->supportsAtLeastExtended() ? ($documentPosition->getAssociatedDocumentLineDocument()?->getLineStatusCode()?->getValue() ?? '') : '';
        $newLineStatusReasonCode = $this->supportsAtLeastExtended() ? ($documentPosition->getAssociatedDocumentLineDocument()?->getLineStatusReasonCode()?->getValue() ?? '') : '';
    ...
    public function getDocumentPositionNote(
        ...
        $newContentCode = $this->supportsAtLeastExtended() ? ($documentPositionNote->getContentCode()?->getValue() ?? '') : '';
        $newSubjectCode = $this->supportsAtLeastExtended() ? ($documentPositionNote->getSubjectCode()?->getValue() ?? '') : '';
    ...
    public function getDocumentPositionProductDetails(
        ...
        $newProductDescription = $this->supportsAtLeastEn16931() ? ($documentPositionProduct?->getDescription()?->getValue() ?? '') : '';
        $newProductSellerId = $this->supportsAtLeastEn16931() ? ($documentPositionProduct?->getSellerAssignedID()?->getValue() ?? '') : '';
        $newProductBuyerId = $this->supportsAtLeastEn16931() ? ($documentPositionProduct?->getBuyerAssignedID()?->getValue() ?? '') : '';
        ...
        $newProductIndustryId = $this->supportsAtLeastExtended() ? ($documentPositionProduct?->getIndustryAssignedID()?->getValue() ?? '') : '';
        $newProductModelId = $this->supportsAtLeastExtended() ? ($documentPositionProduct?->getModelID()?->getValue() ?? '') : '';
        $newProductBatchId = $this->supportsAtLeastExtended() ? (false !== $documentPositionProductBatchId ? ($documentPositionProductBatchId->getValue() ?? '') : '') : '';
        $newProductBrandName = $this->supportsAtLeastExtended() ? ($documentPositionProduct?->getBrandName()?->getValue() ?? '') : '';
        $newProductModelName = $this->supportsAtLeastExtended() ? ($documentPositionProduct?->getModelName()?->getValue() ?? '') : '';
        $newProductOriginTradeCountry = $this->supportsAtLeastEn16931() ? ($documentPositionProduct?->getOriginTradeCountry()?->getID()?->getValue() ?? '') : '';
    ...
    public function getDocumentPositionProductCharacteristic(
        ...
        $newProductCharacteristicType = $this->supportsAtLeastExtended() ? ($documentPositionProductCharacteristic->getTypeCode()?->getValue() ?? '') : '';
        $newProductCharacteristicMeasureValue = $this->supportsAtLeastExtended() ? ($documentPositionProductCharacteristic->getValueMeasure()?->getValue() ?? 0.0) : 0.0;
        $newProductCharacteristicMeasureUnit = $this->supportsAtLeastExtended() ? ($documentPositionProductCharacteristic->getValueMeasure()?->getUnitCode() ?? '') : '';
    ...
    public function getDocumentPositionProductClassification(
        ...
        $newProductClassificationListId = $this->supportsAtLeastEn16931() ? ($documentPositionProductClassification->getClassCode()?->getListID() ?? '') : '';
        $newProductClassificationListVersionId = $this->supportsAtLeastEn16931() ? ($documentPositionProductClassification->getClassCode()?->getListVersionID() ?? '') : '';
        $newProductClassificationCodeClassname = $this->supportsAtLeastExtended() ? ($documentPositionProductClassification->getClassName()?->getValue() ?? '') : '';
    ...
    public function getDocumentPositionBuyerOrderReference(
        ...
        $newReferenceNumber = $this->supportsAtLeastExtended() ? ($documentPositionBuyerOrderReference->getIssuerAssignedID()?->getValue() ?? '') : '';
    ...
    {
        if ($this->supportsNotAtLeastEn16931()) { // EXTENDED 0..n OTHER 0..1
            return false;
        }
    ...
    public function getDocumentPositionGrossPriceAllowanceCharge(
        ...
        $newGrossPriceAllowanceChargePercent = $this->supportsAtLeastExtended() ? ($positionGrossPriceAllowanceCharge->getCalculationPercent()?->getValue() ?? 0.0) : 0.0;
        $newGrossPriceAllowanceChargeBasisAmount = $this->supportsAtLeastExtended() ? ($positionGrossPriceAllowanceCharge->getBasisAmount()?->getValue() ?? 0.0) : 0.0;
        $newGrossPriceAllowanceChargeReason = $this->supportsAtLeastExtended() ? ($positionGrossPriceAllowanceCharge->getReason()?->getValue() ?? '') : '';
        $newGrossPriceAllowanceChargeReasonCode = $this->supportsAtLeastExtended() ? ($positionGrossPriceAllowanceCharge->getReasonCode()?->getValue() ?? '') : '';
    ...
    public function getDocumentPositionQuantities(
        ...
        $newChargeFreeQuantity = $this->supportsAtLeastExtended() ? ($documentPosition->getSpecifiedLineTradeDelivery()?->getChargeFreeQuantity()?->getValue() ?? 0.0) : 0.0;
        $newChargeFreeQuantityUnit = $this->supportsAtLeastExtended() ? ($documentPosition->getSpecifiedLineTradeDelivery()?->getChargeFreeQuantity()?->getUnitCode() ?? '') : '';
        $newPackageQuantity = $this->supportsAtLeastExtended() ? ($documentPosition->getSpecifiedLineTradeDelivery()?->getPackageQuantity()?->getValue() ?? 0.0) : 0.0;
        $newPackageQuantityUnit = $this->supportsAtLeastExtended() ? ($documentPosition->getSpecifiedLineTradeDelivery()?->getPackageQuantity()?->getUnitCode() ?? '') : '';
        $newPerPackageUnitQuantity = $this->supportsAtLeastExtended() ? ($documentPosition->getSpecifiedLineTradeDelivery()?->getPerPackageUnitQuantity()?->getValue() ?? 0.0) : 0.0;
        $newPerPackageUnitQuantityUnit = $this->supportsAtLeastExtended() ? ($documentPosition->getSpecifiedLineTradeDelivery()?->getPerPackageUnitQuantity()?->getUnitCode() ?? '') : '';
    ...
    public function getDocumentPositionBillingPeriod(
        ...
        $newDescription = $this->supportsAtLeastExtended() ? ($positionBillingPeriod->getDescription()?->getValue() ?? '') : '';
    ...
    public function getDocumentPositionTax(
        ...
        $newTaxAmount = $this->supportsAtLeastExtended() ? ($positionTax->getCalculatedAmount()?->getValue() ?? 0.0) : 0.0;
        $newTaxPercent = $positionTax->getRateApplicablePercent()?->getValue() ?? 0.0;
        $newExemptionReason = $this->supportsAtLeastExtended() ? ($positionTax->getExemptionReason()?->getValue() ?? '') : '';
        $newExemptionReasonCode = $this->supportsAtLeastExtended() ? ($positionTax->getExemptionReasonCode()?->getValue() ?? '') : '';
    ...
    public function getDocumentPositionPostingReference(
        ...
        $newType = $this->supportsAtLeastExtended() ? ($positionPostingReference->getTypeCode()?->getValue() ?? '') : '';
     ...
     *
     * @param  InvoiceSuiteZfFxUnifiedProfiles $requestedMinimumProdileId
     * @return bool
     */
    protected function supportsAtLeast(InvoiceSuiteZfFxUnifiedProfiles $requestedMinimumProdileId): bool
    {
     ...
     * @return bool
     */
    protected function supportsNotAtLeast(InvoiceSuiteZfFxUnifiedProfiles $requestedMinimumProdileId): bool
    {
     ...
     * @return bool
     */
    protected function supportsNotAtLeastWithTace(InvoiceSuiteZfFxUnifiedProfiles $requestedMinimumProdileId, string $method): bool
    {
    ...
    {
        return $this->supportsAtLeast(InvoiceSuiteZfFxUnifiedProfiles::EXTENDED);
    }
    ...
    {
        return $this->supportsAtLeast(InvoiceSuiteZfFxUnifiedProfiles::EN16931);
    }
    ...
    {
        return $this->supportsAtLeast(InvoiceSuiteZfFxUnifiedProfiles::BASIC);
    }
    ...
    {
        return $this->supportsAtLeast(InvoiceSuiteZfFxUnifiedProfiles::BASICWL);
    }
    ...
    {
        return $this->supportsAtLeast(InvoiceSuiteZfFxUnifiedProfiles::MINIMUM);
    }
    ...
    {
        return $this->supportsNotAtLeast(InvoiceSuiteZfFxUnifiedProfiles::EXTENDED);
    }
    ...
    {
        return $this->supportsNotAtLeast(InvoiceSuiteZfFxUnifiedProfiles::EN16931);
    }
    ...
    {
        return $this->supportsNotAtLeast(InvoiceSuiteZfFxUnifiedProfiles::BASIC);
    }
    ...
    {
        return $this->supportsNotAtLeast(InvoiceSuiteZfFxUnifiedProfiles::BASICWL);
    }
    ...
    {
        return $this->supportsNotAtLeast(InvoiceSuiteZfFxUnifiedProfiles::MINIMUM);
    }
    ...
    {
        return $this->supportsNotAtLeastWithTace(InvoiceSuiteZfFxUnifiedProfiles::EXTENDED, $method);
    }
    ...
    {
        return $this->supportsNotAtLeastWithTace(InvoiceSuiteZfFxUnifiedProfiles::EN16931, $method);
    }
    ...
    {
        return $this->supportsNotAtLeastWithTace(InvoiceSuiteZfFxUnifiedProfiles::BASIC, $method);
    }
    ...
    {
        return $this->supportsNotAtLeastWithTace(InvoiceSuiteZfFxUnifiedProfiles::BASICWL, $method);
    }
    ...
    {
        return $this->supportsNotAtLeastWithTace(InvoiceSuiteZfFxUnifiedProfiles::MINIMUM, $method);
    }
}
