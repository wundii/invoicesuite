...
use horstoeko\invoicesuite\documents\models\zffxcomfort\udt\DateTimeType\DateTimeStringAType;
...
class DateTimeType
{
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffxcomfort\udt\DateTimeType\DateTimeStringAType")
     * @JMS\Expose
