...
use horstoeko\invoicesuite\documents\models\zffxbasic\udt\DateTimeType\DateTimeStringAType;
...
class DateTimeType
{
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffxbasic\udt\DateTimeType\DateTimeStringAType")
     * @JMS\Expose
