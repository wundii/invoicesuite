...
namespace horstoeko\invoicesuite\documents\models\zffx\rsm;
...
class CrossIndustryInvoiceType
{
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffx\ram\ExchangedDocumentContextType")
     * @JMS\Expose
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffx\ram\ExchangedDocumentType")
     * @JMS\Expose
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffx\ram\SupplyChainTradeTransactionType")
     * @JMS\Expose
