...
class HeaderTradeDeliveryType
{
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("array<horstoeko\invoicesuite\documents\models\zffx\ram\LogisticsTransportMovementType>")
     * @JMS\Expose
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffx\ram\SupplyChainEventType")
     * @JMS\Expose
