...
use horstoeko\invoicesuite\documents\models\zffx\udt\DateTimeType\DateTimeStringAType;
...
class DateTimeType
{
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffx\udt\DateTimeType\DateTimeStringAType")
     * @JMS\Expose
