...
namespace horstoeko\invoicesuite\documents\models\zffxbasicwl\rsm;
...
class CrossIndustryInvoiceType
{
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffxbasicwl\ram\ExchangedDocumentContextType")
     * @JMS\Expose
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffxbasicwl\ram\ExchangedDocumentType")
     * @JMS\Expose
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffxbasicwl\ram\SupplyChainTradeTransactionType")
     * @JMS\Expose
