...
use horstoeko\invoicesuite\documents\models\zffxbasicwl\udt\DateTimeType\DateTimeStringAType;
...
class DateTimeType
{
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffxbasicwl\udt\DateTimeType\DateTimeStringAType")
     * @JMS\Expose
