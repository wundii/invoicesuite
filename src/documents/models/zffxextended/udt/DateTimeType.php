...
use horstoeko\invoicesuite\documents\models\zffxextended\udt\DateTimeType\DateTimeStringAType;
...
class DateTimeType
{
     ...
     * @JMS\Groups({"zffx"})
     * @JMS\Type("horstoeko\invoicesuite\documents\models\zffxextended\udt\DateTimeType\DateTimeStringAType")
     * @JMS\Expose
