 ...
 */
class InvoiceSuitePdfWriter extends PdfFpdi
{
    /**
     ...
     * @return void
     */
    public function setDeterministicModeEnabled(bool $newDeterministicModeEnabled): void
    {
        $this->deterministicModeEnabled = $newDeterministicModeEnabled;
    }
    ...
    protected function _putoutputintent(): void
    {
        ...
        $icc = file_get_contents(InvoiceSuiteSettings::getFullPdfIccProfileFilename());
        $icc = gzcompress($icc);
