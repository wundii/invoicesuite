...
use horstoeko\invoicesuite\models\zffxbasicwl\ram\DocumentContextParameterType;
...
class InvoiceSuiteZfFxBasicWlProviderBuilder extends InvoiceSuiteAbstractFormatProviderBuilder
{
    /**
     * @inheritDoc
     */
