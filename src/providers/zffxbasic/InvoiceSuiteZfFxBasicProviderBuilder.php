...
use horstoeko\invoicesuite\models\zffxbasic\ram\DocumentContextParameterType;
...
class InvoiceSuiteZfFxBasicProviderBuilder extends InvoiceSuiteAbstractFormatProviderBuilder
{
    /**
     * @inheritDoc
     */
