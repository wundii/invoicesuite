...
class InvoiceSuiteZfFxBasicWlProviderBuilder extends InvoiceSuiteAbstractDocumentFormatBuilder
{
    /**
     * @inheritDoc
     */
    public function initDocumentRootObject(): InvoiceSuiteZfFxBasicWlProviderBuilder
    {
