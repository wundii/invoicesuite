...
/**
 * Class representing the ZUGFeRD document profiles
 *
...
class ZugferdProfiles
{
    ...
    public const PROFILEDEF = [
        self::PROFILE_BASIC => [
            ...
            'invoicesuiteproviderid' => 'zffxbasic',
        ],
        self::PROFILE_BASICWL => [
            ...
            'invoicesuiteproviderid' => 'zffxbasicwl',
        ],
        self::PROFILE_EN16931 => [
            ...
            'invoicesuiteproviderid' => 'zffxcomfort',
        ],
        self::PROFILE_EXTENDED => [
            ...
            'invoicesuiteproviderid' => 'zffxextended',
        ],
        ...
        self::PROFILE_MINIMUM => [
            ...
            'invoicesuiteproviderid' => 'zffxminimum',
        ],
