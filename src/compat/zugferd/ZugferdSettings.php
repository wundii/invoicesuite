...
class ZugferdSettings
{
    ...
    {
        return InvoiceSuiteSettings::getAmountDecimals();
    }
    ...
    {
        return InvoiceSuiteSettings::getQuantityDecimals();
    }
    ...
    {
        return InvoiceSuiteSettings::getPercentDecimals();
    }
    ...
    {
        return InvoiceSuiteSettings::getMeasureDecimals();
    }
    ...
    {
        return InvoiceSuiteSettings::getDecimalSeparator();
    }
    ...
    {
        return InvoiceSuiteSettings::getThousandsSeparator();
    }
    ...
    {
        return InvoiceSuiteSettings::getSpecialDecimalPlacesMaps();
    }
    ...
    {
        return InvoiceSuiteSettings::getSerializerCacheDirectory();
    }
    ...
    {
        return InvoiceSuitePathUtils::combineAllPaths(static::getSourceDirectory(), 'assets');
    }
    ...
    {
        return InvoiceSuitePathUtils::combineAllPaths(static::getSourceDirectory(), 'yaml');
    }
    ...
    {
        return InvoiceSuitePathUtils::combineAllPaths(static::getSourceDirectory(), 'validation');
    }
    ...
    {
        return InvoiceSuitePathUtils::combineAllPaths(static::getSourceDirectory(), 'schema');
    }
    ...
    {
        return InvoiceSuitePathUtils::combineAllPaths(static::getSchemaDirectory(), 'schematron');
    }
    ...
    {
        return InvoiceSuitePathUtils::combineAllPaths(static::getSchemaDirectory(), 'xslt');
    }
    ...
    {
        return InvoiceSuitePathUtils::combinePathWithFile(static::getAssetDirectory(), static::$iccProfileFilename);
    }
    ...
    {
        return InvoiceSuitePathUtils::combinePathWithFile(static::getAssetDirectory(), static::$xmpMetaDataFilename);
    }
}
